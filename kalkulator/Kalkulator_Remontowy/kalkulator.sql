...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 03, 2023 at 01:44 PM
...
--
ALTER TABLE `instalation`
  MODIFY `id_instalation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `paint`
--
ALTER TABLE `paint`
  MODIFY `id_paint` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
