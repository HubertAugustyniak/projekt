		...
		<div class="hero-image">
			<div class="hero-image__login">
				...
				<form method="POST" action="register.php">
					...
					<br><input type="text" name="name" placeholder="Nazwa użytkownika" required> <br>
					<br><input type="email" name="email" placeholder="E-mail" required><br>
					<br><input type="password" name="password" placeholder="Hasło" required><br>
					<br><input class="login-btn" type="submit" name="submit" value="Zarejestruj się"><br>
				</form>
				</p>
			</div>
