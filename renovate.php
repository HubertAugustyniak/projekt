		...
		<div class="service">
			...
			<div class="start-renovation">
				<form class="start-renovation__text" method="POST" action="calculate.php">
					<label for="paint">Podaj nazwę remontu:</label>
					<input class="description" id="paint" type="text" name="paint"></input>
					<input class="btn-description" type="submit" name="submit_3" value="Dodaj" />
				</form>
			</div>
