...
--
-- Host: 127.0.0.1
-- Czas generowania: 31 Mar 2023, 18:20
...
INSERT INTO `instalacja` (`id_instalacji`, `user`, `pow_podlogi`, `rodzaj_materialu`, `ile_sztuk`, `suma`) VALUES
(1, 'adam', 30, '', 0, 1320);
...
--
ALTER TABLE `instalacja`
  MODIFY `id_instalacji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT dla tabeli `malowanie`
--
ALTER TABLE `malowanie`
  MODIFY `id_malowania` int(11) NOT NULL AUTO_INCREMENT;
